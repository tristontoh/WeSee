export type TenantKey = 'sme' | 'plc' | 'admin';
...
export const NAV: Record<TenantKey, NavItem[]> = {
  ...
  plc: [
    { key: 'overview', label: 'Carbon Overview', path: '/plc/overview', d: 'M12 3v9l7.5 4.3M12 3a9 9 0 109 9' },
    { key: 'ledger', label: 'Assurance Ledger', path: '/plc/ledger', d: 'M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01' },
    { key: 'arbitrage', label: 'Sourcing Arbitrage', path: '/plc/arbitrage', d: 'M23 6l-9.5 9.5-5-5L1 18M17 6h6v6' },
    { key: 'report', label: 'Report Builder', path: '/plc/report', d: 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v6h6M9 13h6M9 17h6' },
    { key: 'compliance', label: 'Compliance Exports', path: '/plc/compliance', d: 'M9 12l2 2 4-4M12 3l7 4v5c0 4-3 7-7 8-4-1-7-4-7-8V7z' },
  ],
  admin: [
