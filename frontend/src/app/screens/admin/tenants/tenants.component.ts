  ...
  template: `
    <div style="animation:vfade .3s ease both;">
      <div style="display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:22px;">
        <div><h1 style="font-family:'Cormorant Garamond',serif;font-size:38px;font-weight:600;margin:0 0 6px;letter-spacing:-.5px;">Tenants</h1><p style="color:#64726B;margin:0;font-size:14px;">All SME and PLC workspaces on the platform.</p></div>
      ...
      <div class="grid-4" style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
        ...
        <div class="glass" style="border-radius:13px;padding:16px 18px;"><div style="font-size:12px;color:#8A968F;margin-bottom:8px;">SME</div><div style="font-family:'Work Sans',monospace;font-size:24px;font-weight:600;">1,196</div></div>
        <div class="glass" style="border-radius:13px;padding:16px 18px;"><div style="font-size:12px;color:#8A968F;margin-bottom:8px;">PLC</div><div style="font-family:'Work Sans',monospace;font-size:24px;font-weight:600;">88</div></div>
